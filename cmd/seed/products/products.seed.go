...
var DescriptionText = `Yacco Lube S/03 5W30 ზეთი არის 100% სინთეტიკური ზეთი ბენზინისა და დიზელის ძრავებისთვის.
...
var Seed = []model.Products{
	{
		...
		CategoryID: 1,
		TechnicalSheetUrl: "https://yacco.com/upload/media/default/0001/17/988f07e3899979d5115d96ecb06931e7c8ef5ab5.pdf",
		ThumbnailID: 34,
		...
		Properties: []model.Product_properties{
			{Name: "3085", Slug: "3085"},
			{Name: "100% SYNTHÈSE", Slug: "100%_SYNTHÈSE"},
			{Name: "VISCOSITÉ :5W30", Slug: "VISCOSITÉ_:5W30"},
		},
