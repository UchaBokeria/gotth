...
func About() {
	for _, row := range []model.Interface_about{
		{
			InterfaceID: 1,
			Ver:         1,
			Body:        `მართეთ საქმიანობა პროცესების საშუალებით, შეიმუშაოთ, აწარმოოთ და მიაწოდოთ ხარისხიანი პროდუქტები, რომლებიც აკმაყოფილებენ მისი მომხმარებლების მოლოდინს,
							გაზომეთ მომხმარებელთა კმაყოფილება და განახორციელეთ ქმედებები მისი გასაუმჯობესებლად.
							თქვენი საქმიანობის კონტროლი
							
							უსაფრთხოების, ჯანმრთელობის, გარემოს დაცვისა და ხარისხის მართვის სისტემების მუშაობის უზრუნველყოფა
							განსაზღვრეთ მიზნები და გაზომეთ შედეგები შესაბამისი ინდიკატორების გამოყენებით,
							სხვადასხვა სტანდარტებისა და რეგულაციების დაცვის მონიტორინგიმართეთ საქმიანობა პროცესების საშუალებით, შეიმუშაოთ, აწარმოოთ და მიაწოდოთ ხარისხიანი პროდუქტები, რომლებიც აკმაყოფილებენ მისი მომხმარებლების მოლოდინს,
							გაზომეთ მომხმარებელთა კმაყოფილება და განახორციელეთ ქმედებები მისი გასაუმჯობესებლად.
							თქვენი საქმიანობის კონტროლი
							...
							უსაფრთხოების, ჯანმრთელობის, გარემოს დაცვისა და ხარისხის მართვის სისტემების მუშაობის უზრუნველყოფა
							განსაზღვრეთ მიზნები და გაზომეთ შედეგები შესაბამისი ინდიკატორების გამოყენებით,
							სხვადასხვა სტანდარტებისა და რეგულაციების დაცვის მონიტორინგი`,
			Terms:       `1. შეთანხმების საგანი
			...
			1.5. "კომპანია" უფლებამოსილია ცალმხრივად ნებისმიერ დროს შეიტანოს ცვლილება წინამდებარე შეთანხმებაში, რის შესახებაც ინფორმაციას განათავსებს ვებ-გვერდზე -  https://www.alfamotors.ge/.
			...
			2.4 იმ შემთხვევაში, თუ "მომხმარებელი" დარეგისტრირებულია შპს "ალფა მოტორსის" (ს/კ: 202177205) მომხმარებელთა ბაზაში და ფლობს ამ კომპანიის ლოიალობის ბარათს, წინამდებარე შეთანხმებაზე ხელმოწერით, "მომხმარებელი" ანიჭებს "კომპანიას" უფლებამოსილებას შპს "ალფა მოტორსისგან" (ს/კ: 202177205) გამოითხოვოს ინფორმაცია "მომხმარებლის" მიერ შპს "ალფა მოტორსში" შესყიდული საქონლის/პროდუქციის ან/და მომსახურების სრული ღირებულების შესახებ, ხოლო შპს "ალფა მოტორსს" ანიჭებს უფლებამოსილებას "კომპანიის" მოთხოვნის შემთხვევაში გადასცეს მას აღნიშნული ინფორმაცია.
			...
			4.2 "მომხმარებელი" უფლებამოსილია "კომპანიის" საქონელი შეიძინოს "კომპანიის" მიერ შემოთავაზებული ნებისმიერი საშუალებით, მათ შორის, "კომპანიის"  სერვის-ცენტრის ან/და მაღაზიის, მობილური სერვისის (ადგილზე მომსახურება), ასევე, ონლაინ-მაღაზიის მეშვეობით ვებ.გვერდზე:  https://shop.alfamotors.ge/.
			...
			5.1 "მომხმარებელსა" და "კომპანიას" შორის არსებული ურთიერთობის დროს, ნებისმიერი სახის საქონლის ან/და მომსახურების შეძენის შემთხვევაში, დეტალური საგარანტიო პირობები განთავსებულია ვებ-გვერდზე https://www.alfamotors.ge/. "კომპანია" უფლებამოსილია ნებისმიერ დროს, ცალმხრივად შეცვალოს საგარანტიო პირობები. ასევე, გარანტია ვრცელდება "კომპანიის" სერვის-ცენტრში გამოყენებულ/დამონტაჟებულ საქონელზე, რომელიც შეძენილი იქნება "კომპანიაში";
			...
			6.5. იმ შემთხვევაში, თუ "მომხმარებელი" წინამდებარე "შეთანხმების" გაფორმებამდე, დარეგისტრირებულია შპს "ალფა მოტორსის" (ს/კ: 202177205) ბიზნეს პროცესების მართვის სისტემის (SAP) სამომხმარებლო ბაზაში, "მომხმარებელი" ანიჭებს "კომპანიას" უფლებამოსილებას შპს "ალფა მოტორსისგან" გამოითხოვოს წინამდებარე შეთანხმების 6.2 პუნქტში მითითებული "მომხმარებლის" პერსონალური მონაცემები, ხოლო შპს "ალფა მოტორსს" ანიჭებს უფლებამოსილებას "კომპანიის" მოთხოვნის შემთხვევაში გადასცეს მას აღნიშნული ინფორმაცია.
